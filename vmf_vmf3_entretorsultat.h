...
#ifndef vmf_vmf3_entretorsultat_H_INCLUDED
#define vmf_vmf3_entretorsultat_H_INCLUDED
...
public:
	...
	{
		vmf3_entretorsultat vmf;
		vmf3_entretorsultat::hash_type::iterator it = vmf.hash.find(var1_entr_e);
		if (it != vmf.hash.end())
			return altova::Core::Box((*it).second);
		else
			return altova::Core::Box((hash_type::value_type::second_type)string_type(_T("")));
	}
...
#endif // vmf_vmf3_entretorsultat_H_INCLUDED
